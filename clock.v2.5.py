...
# v2.5
# OpenWeatherAPI key as config variable
...
openweatherappid=config.get("system","openweatherappid")
...
def get_data():
	...
	try:
		url="http://api.openweathermap.org/data/2.5/weather?q=Westerham,uk&APPID="+openweatherappid
